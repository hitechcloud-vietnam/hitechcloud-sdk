# HiTechCloud hitechcloud-sdk — Dart SDK
...
```yaml
dependencies:
  hitechcloud_sdk: ^1.0.0
```

## Quick Start

```dart
import 'package:hitechcloud_sdk/hitechcloud_sdk.dart';

void main() async {
  final client = Client(baseUrl: 'https://api.hitechcloud.vn', token: 'your-token');
  final result = await client.affiliate.getSummary();
  print(result);
}
```
