# HiTechCloud hitechcloud-sdk — PowerShell SDK
...
```powershell
Import-Module ./HiTechCloudSDK/HiTechCloudSDK.psd1
New-HiTechCloudClient -BaseUrl "https://api.hitechcloud.vn" -Token 'your-token'
```
