# HiTechCloud hitechcloud-sdk — Swift SDK
...
```swift
dependencies: [
    .package(url: "https://github.com/hitechcloud/hitechcloud-sdk-swift.git", from: "1.0.0")
]
```
...
let client = Client(baseUrl: "https://api.hitechcloud.vn", token: "your-token")
let result = try client.affiliate.getSummary()
print(result)
```
